...
export const Subscribe = () => {
  ...
  return (
    ...
    <div className="top-bottom__reviews">
      <div className="top-bottom__reviews-img"><img src='img/review.png' alt="Фотография покупателя" /></div>
      <div className="top-bottom__text">
        ...
        <div>
          <img className="top-bottom__scroll" src='img/lineWhite.png' alt="" />
          <img className="top-bottom__scroll" src='img/linePink.png' alt="" />
          <img className="top-bottom__scroll" src='img/lineWhite.png' alt="" />
        </div>
      </div>
    </div>
